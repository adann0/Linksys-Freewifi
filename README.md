...
Après le reset, si tout a fonctionné, à l'adresse 192.168.1.1 se trouve le routeur (password : admin)
...
Pas besoin de refaire un reset 30/30/30 sauf si on veut upgrade sur un autre firmware dd-wrt.
